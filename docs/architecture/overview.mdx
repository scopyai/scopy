...
description: "High-level map of the Review system."
---

Review is split into a typed web/API product surface, a worker-backed GitHub integration, and a repository analysis toolkit used by the review agent.
...
9. Review run, usage, billing, and debug metadata are persisted.
...
- Review runs, findings, model usage, and billing transactions.
